...
class MinisterialAIEnhanced {
  ...
  get translations() {
    return {
      welcome: {
        es: "¡Hola! Soy El Agente AI del Ministerio del Pastor Frankie Felicie, tu asistente del ministerio. ¿En qué puedo ayudarte hoy?",
        en: "Hello! I'm Pastor Frankie Felicie's Ministry AI Assistant. How can I help you today?"
      },
      ministryInfo: {
